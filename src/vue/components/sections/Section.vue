<template>
    <section :id="model.htmlId"
             ...
             class="main-section"
             :class="{
                'main-section-svh': utils.isIOS(),
                'main-section-with-divider': presentationMode === constants.PresentationModes.ALL_AT_ONCE,
                'main-section-cover': !model.isDefault
             }">
...
section.main-section-with-divider {
