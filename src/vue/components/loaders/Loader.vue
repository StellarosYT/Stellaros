<template>
    ...
    <div v-if="visible && currentStep"
         ...
         class="main-loader"
         :class="{
            'main-loader-tween-in': currentStep === Steps.WILL_ENTER,
            'main-loader-tween-out': currentStep === Steps.LEAVING
         }">
        <!-- Loader Content -->
        <div class="main-loader-content">
            <ImageView src="images/icons/icon.ico"
                       alt="Logo"
            ...
            <div class="main-loader-progress-display"
                 :class="{
                    'main-loader-progress-display-hidden': currentStep <  Steps.ANIMATING_PROGRESS,
                    'transition-none': currentStep < Steps.ANIMATING_PROGRESS
                 }">
                <p class="percentage text-2"
                   v-html="`${percentage}%`"/>

                <ProgressBar class="main-loader-progress-bar"
...
const _updateProgress = (dt) => {
    const isPageLoaded = Boolean(document.querySelector('#main'))
...
div.main-loader-progress-display {
    margin-top: 10px;
    overflow: hidden;
    z-index: 5;
